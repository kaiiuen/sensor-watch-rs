...
/// SHA-256 implementation (FIPS 180-4), pure Rust with no dependencies.
pub struct Sha256 {
    state: [u32; 8],
    buffer: [u8; 64],
    buffer_len: usize,
...
/// Computes the SHA-256 of a byte slice, returned as a lowercase hex string.
...
/// Computes the SHA-256 of the running executable.
