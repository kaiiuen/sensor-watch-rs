...
pub fn tr(lang: Language, key: Key) -> &'static str {
    match lang {
        Language::English => match key {
            ...
            Key::Theme => "Theme",
            Key::TabLayout => "Tab layout",
            Key::TabLayoutAuto => "Auto",
            Key::TabLayoutOneRow => "One row",
            Key::TabLayoutTwoRows => "Two rows",
            Key::TabLayoutThreeRows => "Three rows",
            Key::TabOverflow => "Tab overflow",
            Key::TabOverflowWrap => "Wrap (recommended)",
            Key::TabOverflowScroll => "Horizontal scroll",
            Key::Ready => "Ready",
        ...
        Language::ChineseSimplified => match key {
            ...
            Key::Theme => "主题",
            Key::TabLayout => "标签布局",
            Key::TabLayoutAuto => "自动",
            Key::TabLayoutOneRow => "一行",
            Key::TabLayoutTwoRows => "两行",
            Key::TabLayoutThreeRows => "三行",
            Key::TabOverflow => "标签溢出",
            Key::TabOverflowWrap => "换行（推荐）",
            Key::TabOverflowScroll => "水平滚动",
            Key::Ready => "就绪",
        ...
        Language::ChineseTraditional => match key {
            ...
            Key::Theme => "主題",
            Key::TabLayout => "分頁配置",
            Key::TabLayoutAuto => "自動",
            Key::TabLayoutOneRow => "一列",
            Key::TabLayoutTwoRows => "兩列",
            Key::TabLayoutThreeRows => "三列",
            Key::TabOverflow => "分頁溢出",
            Key::TabOverflowWrap => "換行（推薦）",
            Key::TabOverflowScroll => "水平捲動",
            Key::Ready => "就緒",
